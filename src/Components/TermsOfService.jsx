  ...
  return (
    <Box textAlign='center' py={10} px={6}>
      ...
      <Text color={'gray.500'}>
        ...
        F. Presa is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
        ...
        The Travelogue Travel Diary app stores and processes personal data that you have provided to us, to provide my
        ...
        Travelogue Travel Diary app won’t work properly or at all.

        The app does use third-party services that declare their Terms and Conditions.

        Link to Terms and Conditions of third-party service providers used by the app
        <div>
          <a href='https://firebase.google.com/terms/analytics' target='_blank' rel='noopener noreferrer'>Google
        ...
        You should be aware that there are certain things that F. Presa will not take responsibility for. Certain
        functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi or
        provided by your mobile network provider, but F. Presa cannot take responsibility for the app not working at
        ...
        Along the same lines, F. Presa cannot always take responsibility for the way you use the app i.e. You need to
        make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the
        Service, F. Presa cannot accept responsibility.

        With respect to F. Presa’s responsibility for your use of the app, when you’re using the app, it’s important to
        bear in mind that although we endeavor to ensure that it is updated and correct at all times, we do rely on
        third parties to provide information to us so that we can make it available to you. F. Presa accepts no
        ...
        change, and you’ll need to download the updates if you want to keep using the app. F. Presa does not promise
        that it will always update the app so that it is relevant to you and/or works with the Android & iOS version
        that you have installed on your device. However, you promise to always accept updates to the application when
        ...
        These terms and conditions are effective as of 2023-07-22
